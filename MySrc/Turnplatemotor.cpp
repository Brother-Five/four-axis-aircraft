...
//u16 ESC_PWM_speed ;//正常时刻PWM值
//u16 ESC_PWM_volate;//用来对不同电压值修正PWM值
//void ESCSetPara(float _mESC_PWM_speed,float _mESC_PWM_volate)
//{
//	
//	ESC_PWM_speed  = (uint16_t)_mESC_PWM_speed; 
//	ESC_PWM_volate = (uint16_t)_mESC_PWM_volate;
...
// u8 constantly_flag =
//#define RSF 100
u8 ESC_PWM1           = 21;//正常时刻PWM值
u8 ESC_PWM2           = 21;//正常时刻PWM值
u8 ESC_PWM_CONSTANTLY = 21;//连发PWM值
